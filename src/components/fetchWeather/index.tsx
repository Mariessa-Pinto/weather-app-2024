        ...
        <div className={`container mx-auto font-poppins`}>
            {
                currentWeather && (
                    <div>
                        <h2 className={`text-2xl font-medium mt-10 mb-10`}>Current Weather</h2>
                        <div className={`flex flex-row items-center justify-center gap-40 mb-8`}>
                            <Image
                                className={`ml-5 mb-6`}
                                ...
                                width={200}
                            />
                            <div className={`text-6xl font-light`}>{(currentWeather.main.temp - 273.15).toFixed(1)} °C</div>
                        </div>
            ...
            {searchClicked && isDataLoaded && (
                <div>
                    <h2 className={`text-2xl font-medium mt-20 mb-8`}>Every 3 Hours For Next 5 Days</h2>
                        ...
                        <div key={index}>
                            ...
                            <div className="flex flex-wrap">
                                {forecasts.map((forecast, i) => (
                                    <div key={i} className="w-1/4 p-4 border rounded-md flex flex-col items-center gap-2 m-4 mb-2 mt-2">
